  ...
  return (
    <section className="max-padd container flex flex-col gap-8 xl:flex-row bg-primary py-4">
      ...
      <div className="flex-col flex xl:flex-[1.5] bg-white px-6 py-2 rounded-xl">
        ...
        <div className="flex items-baseline gap-x-6 bold-24 xl:bold-28 mt-3">
        ...
        <div className="flex flex-col sm:flex-row gap-x-10 gap-y-3 my-4">
          <div>
            <h4 className="bold-16">Seclect Color:</h4>
            <div
              className="h-10 w-10 flexCenter cursor-pointer rounded-sm
            bg-secondaryRed border-b-black active-color"
            ></div>
            <div
              className="h-10 w-10 flexCenter cursor-pointer rounded-sm
          bg-secondaryYellow border-b-black "
            ></div>
            <div
              className="h-10 w-10 flexCenter cursor-pointer rounded-sm
            bg-secondaryBlue border-b-black"
            ></div>
            <div
              className="h-10 w-10 flexCenter cursor-pointer rounded-sm
            bg-secondaryGreen border-b-black"
            ></div>
          </div>
          <div>
            ...
            <div className="flex gap-3 my-3">
              <div
                className="border-[1.5px] border-slate-900/15 h-10
              w-10 flexCenter cursor-pointer rounded-sm"
              >
                S
              </div>
              <div
                className="border-[1.5px] border-slate-900 h-10
              w-10 flexCenter cursor-pointer rounded-sm"
              >
                M
              </div>
