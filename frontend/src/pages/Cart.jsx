      ...
      <div className="py-10">
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-900/20 text-gray-30 regular-14 xs:regular-16 text-start py-12">
              ...
              <th className="p-1 text-left">Totals</th>
        ...
        <div className="flex flex-col xl:flex-row gap-20 mt-20">
          ...
          <div className="flex flex-1 flex-col gap-8">
            <h4 className="bold-20 capitalize">You coupon code enter here:</h4>
            <div
              className="flexBetween h-[2.8rem] bg-primary ring-1 ring-slate-900/10 w-full
            max-w-[488px] rounded"
            ></div>
          </div>
        </div>
